...
public class MainActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UniProgress.DialogProgressInfo a = new UniProgress.DialogProgressInfo(R.layout.progress);
        menu1Fragment.progress.bind(a);
//        menu1Fragment.progress.bindDialog(R.layout.progress, new UniProgress.OnProgressListener() {
//            @Override
